    ...
    <form method="POST" action="{{ route('banners.update', $banner) }}" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="color" id="label_color" name="label_color" value="{{ old('label_color', $banner->label_color ?? '#1E3A5F') }}" style="width: 60px; height: 42px; padding: 4px; cursor: pointer;">
            </div>
        </div>
        <div class="form-group">
