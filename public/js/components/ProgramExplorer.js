(function (Vue) {
    ...
    window.BerbagiComponents.ProgramExplorer = {
        ...
        template: '<div>' +
            ...
            '          <span class="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-2.5 py-1 text-xs font-bold text-gray-500" title="Jumlah klik Detail"><i class="fas fa-arrow-pointer"></i> <span>{{ displayKlik(p) }}</span></span>' +
            '        </div>' +
